...
export IMAGE_URL=${IMAGE_URL-artifactory-docker-artifactory-jcr.apps.rosa.rhtap-services.xmdt.p3.openshiftapps.com/rhtap/rhtap-qe-java-quarkus:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhtap-rhdh-qe/rp0f68c9s-java-quarkus-gitops
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-tssc-tas.apps.rosa.kx-f8048369bf.uqg2.p3.openshiftapps.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-tssc-tas.apps.rosa.kx-f8048369bf.uqg2.p3.openshiftapps.com}
...
export COSIGN_PUBLIC_KEY=LS0tLS1CRUdJTiBQVUJMSUMgS0VZLS0tLS0KTUZrd0V3WUhLb1pJemowQ0FRWUlLb1pJemowREFRY0RRZ0FFZzV1aytEMzBxNHAzcHhmZXEvMGtVUldOWjdDbwowZkM5d2Q5TFArYVptRlUzcmJVRUV4cmltWUt5eVpCKzd2WVNINWxIelRJeXZnVGpNQ1ZZeE9DY01nPT0KLS0tLS1FTkQgUFVCTElDIEtFWS0tLS0tCg==
